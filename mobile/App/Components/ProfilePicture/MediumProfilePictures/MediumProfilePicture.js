...
import styles from '../../Styles/ProfilePictureStyles/MediumProfilePictureStyles/MediumProfilePictureStyle'
...
const MediumProfilePicture = (props: Props) => {
...
MediumProfilePicture.defaultProps = {
  image: Images.profilePicture,
  type: 1,
  onPress: () => {}
}

export default MediumProfilePicture
